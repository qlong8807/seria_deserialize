...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4834463208057550753L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"com.cyber\",\"doc\":\"A pair of strings\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
   ...
   */
  public static com.cyber.StringPair.Builder newBuilder() {
    return new com.cyber.StringPair.Builder();
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static com.cyber.StringPair.Builder newBuilder(com.cyber.StringPair.Builder other) {
    return new com.cyber.StringPair.Builder(other);
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static com.cyber.StringPair.Builder newBuilder(com.cyber.StringPair other) {
    return new com.cyber.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
    ...
    private Builder() {
      super(com.cyber.StringPair.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.cyber.StringPair.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.cyber.StringPair other) {
            super(com.cyber.StringPair.SCHEMA$);
      if (isValidValue(fields()[0], other.left)) {
        this.left = data().deepCopy(fields()[0].schema(), other.left);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cyber.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cyber.StringPair.Builder clearLeft() {
      left = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cyber.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cyber.StringPair.Builder clearRight() {
      right = null;
