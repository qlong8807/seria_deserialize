...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"avro\",\"doc\":\"A pair of strings\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
   ...
   */
  public static avro.StringPair.Builder newBuilder() {
    return new avro.StringPair.Builder();
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static avro.StringPair.Builder newBuilder(avro.StringPair.Builder other) {
    return new avro.StringPair.Builder(other);
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static avro.StringPair.Builder newBuilder(avro.StringPair other) {
    return new avro.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.StringPair.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.StringPair other) {
            super(avro.StringPair.SCHEMA$);
      if (isValidValue(fields()[0], other.left)) {
        this.left = data().deepCopy(fields()[0].schema(), other.left);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.StringPair.Builder clearLeft() {
      left = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.StringPair.Builder clearRight() {
      right = null;
